...
function break_new_line(state, offset, width) {
  ...
  return Curry._1(state[/* pp_out_indent */20], state[/* pp_current_indent */9]);
}
  ...
  if (typeof param === "number") {
    switch (param) {
      ...
      case /* Pp_if_newline */4 :
          if (state[/* pp_current_indent */9] !== (state[/* pp_margin */5] - state[/* pp_space_left */8] | 0)) {
            var state$1 = state;
            var match$4 = take_queue(state$1[/* pp_queue */27]);
      ...
      case /* Pp_close_tag */5 :
          ...
          if (match$5) {
            var marker = Curry._1(state[/* pp_mark_close_tag */24], match$5[0]);
    ...
    switch (param.tag | 0) {
      ...
      case /* Pp_open_tag */5 :
          ...
          var marker$1 = Curry._1(state[/* pp_mark_open_tag */23], tag_name);
...
function pp_open_tag(state, tag_name) {
  if (state[/* pp_print_tags */21]) {
    state[/* pp_tag_stack */3] = /* :: */[
      tag_name,
      state[/* pp_tag_stack */3]
    ];
    Curry._1(state[/* pp_print_open_tag */25], tag_name);
  }
  if (state[/* pp_mark_tags */22]) {
...
function pp_close_tag(state, param) {
  ...
  if (state[/* pp_print_tags */21]) {
    ...
    if (match) {
      Curry._1(state[/* pp_print_close_tag */26], match[0]);
...
function pp_get_formatter_tag_functions(state, param) {
  return /* record */[
          /* mark_open_tag */state[/* pp_mark_open_tag */23],
          /* mark_close_tag */state[/* pp_mark_close_tag */24],
          /* print_open_tag */state[/* pp_print_open_tag */25],
          /* print_close_tag */state[/* pp_print_close_tag */26]
        ];
}

function pp_set_formatter_tag_functions(state, param) {
  state[/* pp_mark_open_tag */23] = param[/* mark_open_tag */0];
  state[/* pp_mark_close_tag */24] = param[/* mark_close_tag */1];
  state[/* pp_print_open_tag */25] = param[/* print_open_tag */2];
  state[/* pp_print_close_tag */26] = param[/* print_close_tag */3];
  return /* () */0;
}
...
function pp_set_formatter_out_functions(state, param) {
  ...
  state[/* pp_out_indent */20] = param[/* out_indent */4];
  return /* () */0;
}
...
function pp_get_formatter_out_functions(state, param) {
  return /* record */[
          ...
          /* out_indent */state[/* pp_out_indent */20]
        ];
}
...
function pp_set_formatter_out_channel(state, oc) {
  ...
  state[/* pp_out_indent */20] = (function (param) {
      return display_blanks(state, param);
    });
  return /* () */0;
}
...
function formatter_of_out_functions(out_funs) {
  return pp_make_formatter(out_funs[/* out_string */0], out_funs[/* out_flush */1], out_funs[/* out_newline */2], out_funs[/* out_spaces */3], out_funs[/* out_indent */4]);
}
...
function make_formatter(output, flush) {
  ...
  ppf[/* pp_out_indent */20] = (function (param) {
      return display_blanks(ppf, param);
    });
  return ppf;
}
...
function make_symbolic_output_buffer(param) {
  return /* record */[/* symbolic_output_contents : [] */0];
}

function clear_symbolic_output_buffer(sob) {
  sob[/* symbolic_output_contents */0] = /* [] */0;
  return /* () */0;
}

function get_symbolic_output_buffer(sob) {
  return List.rev(sob[/* symbolic_output_contents */0]);
}

function flush_symbolic_output_buffer(sob) {
  var items = List.rev(sob[/* symbolic_output_contents */0]);
  sob[/* symbolic_output_contents */0] = /* [] */0;
  return items;
}
...
function set_print_tags(param) {
  std_formatter[/* pp_print_tags */21] = param;
  return /* () */0;
}

function get_print_tags(param) {
  return std_formatter[/* pp_print_tags */21];
}

function set_mark_tags(param) {
  std_formatter[/* pp_mark_tags */22] = param;
  return /* () */0;
}

function get_mark_tags(param) {
  return std_formatter[/* pp_mark_tags */22];
}
